...
async function open(target, options = { lazyEntries: true, autoClose: false }) {
    return new Promise((resolve, reject) => {
        ...
        if (typeof target === "string") {
            yauzl.open(target, options, handleZip);
        }
        else if (target instanceof Buffer) {
            yauzl.fromBuffer(target, options, handleZip);
        }
        else {
            yauzl.fromFd(target, options, handleZip);
        }
    });
}
/**
...
exports.getEntriesRecord = getEntriesRecord;
exports.open = open;
exports.openEntryReadStream = openEntryReadStream;
exports.readAllEntries = readAllEntries;
exports.readEntry = readEntry;
exports.walkEntries = walkEntries;
exports.walkEntriesGenerator = walkEntriesGenerator;
